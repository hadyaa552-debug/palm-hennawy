    ...
    <div dir="rtl">
      ...
      <nav className="nav" style={{
        ...
        <div className="desk-links" style={{ display: "flex", gap: 24, alignItems: "center" }}>
          ...
          <a href={`tel:${PHONE}`} dir="ltr" style={{ fontSize: ".82rem", fontWeight: 700, textDecoration: "none", color: scrolled ? "#8B1A1A" : "#fff" }}>0100 900 5579</a>
        ...
        <div className="hero-grid" style={{ position: "relative", zIndex: 10, minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "space-between", maxWidth: 1200, margin: "0 auto", width: "100%", padding: "100px 40px 60px", gap: 48 }}>
          ...
          <div className="hero-text" style={{ flex: 1, maxWidth: 540 }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 18, padding: "6px 14px", background: "rgba(139,26,26,.8)", borderRadius: 20 }}>
              ...
              <span style={{ fontSize: ".7rem", fontWeight: 700, color: "#fff" }}>🏖 أول مطور مصري في رأس الحكمة</span>
            </div>
            ...
            <p style={{ fontSize: ".9rem", color: "rgba(255,255,255,.45)", lineHeight: 1.9, marginBottom: 28, maxWidth: 440 }}>
              مدينة متكاملة على مدار العام — 4.8 كم شاطئ · تصميم OBMI العالمي · مطار دولي · مارينا دولية · 3 فنادق فاخرة · مدينة ذكية.
            </p>
            {/* Stats */}
          ...
          <div className="hero-form" style={{ width: 370, flexShrink: 0, background: "rgba(255,255,255,.97)", backdropFilter: "blur(20px)", borderRadius: 14, overflow: "hidden", boxShadow: "0 20px 60px rgba(0,0,0,.3)" }}>
            ...
            <div style={{ padding: "22px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginTop: 10 }}>
                ...
                <a href={`tel:${PHONE}`} style={{ padding: "11px", border: "1px solid rgba(0,0,0,.08)", color: "#1a1a1a", fontWeight: 700, fontSize: ".72rem", textAlign: "center", textDecoration: "none", borderRadius: 8 }}>📞 اتصل</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="stat-bar" style={{ display: "flex", background: "#fff", borderBottom: "1px solid rgba(0,0,0,.04)" }}>
        {[{ i: "📐", v: "1,400 فدان", l: "المساحة الكلية" }, { i: "🏖", v: "4.8 كم", l: "واجهة شاطئية" }, { i: "💧", v: "84%", l: "مياه وخضرة" }, { i: "🌊", v: "95%", l: "إطلالة بحر/لاجون" }].map((s, i) => (
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <R>
            <div style={{ textAlign: "center", marginBottom: 40 }}>
              ...
              <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "2.2rem", fontWeight: 500, marginBottom: 12 }}>مدينة متكاملة في رأس الحكمة</h2>
              <p style={{ fontSize: ".9rem", color: "#666", maxWidth: 650, margin: "0 auto", lineHeight: 1.9 }}>
                أول مطور مصري في رأس الحكمة — مدينة ذكية متكاملة على مدار العام على مساحة 1,400 فدان بتصميم OBMI العالمي. تقع على كيلو 238 بواجهة شاطئية 4.8 كم. المشروع يضم مطار دولي ومارينا دولية ومنطقة أعمال مركزية وشبكة نقل سريع ومنطقة حرة و3 فنادق فاخرة ونوادي رياضية ومناطق ترفيه ودايننج. 84% من المشروع مساحات مائية وخضرة و95% من الوحدات بإطلالة لاجونز أو بحر مباشر.
              </p>
            </div>
          </R>
          ...
          <R d={.1}>
            <div className="grid4" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 10, marginBottom: 32 }}>
              {[{ v: "1,400", l: "فدان — المساحة الكلية" }, { v: "4.8 كم", l: "واجهة شاطئية على البحر" }, { v: "كيلو 238", l: "موقع استراتيجي في رأس الحكمة" }, { v: "OBMI", l: "شركة التصميم العالمية" }].map((s, i) => (
          ...
          <div className="grid4" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 8, marginBottom: 20 }}>
            {[
              { i: "✈️", t: "مطار دولي", d: "وصول مباشر بدون عناء — المطار داخل المشروع" },
      ...
      <section style={{ background: "#8B1A1A", padding: "40px" }}>
        <div className="mid-cta-grid" style={{ maxWidth: 900, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr auto", alignItems: "center", gap: 32 }}>
          <div>
            <h3 style={{ fontFamily: "'Playfair Display',serif", fontSize: "1.5rem", fontWeight: 500, color: "#fff", marginBottom: 6 }}>مهتم بالمشروع؟ سجّل دلوقتي</h3>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <R d={.2}>
            <div style={{ marginTop: 14, background: "rgba(139,26,26,.05)", borderRadius: 8, padding: "12px", border: "1px solid rgba(139,26,26,.1)", textAlign: "center" }}>
              <span style={{ fontSize: ".82rem", color: "#8B1A1A", fontWeight: 700 }}>مدينة متكاملة في رأس الحكمة
</span>
            </div>
          </R>
        </div>
      ...
      <section id="contact">
        <div className="split" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: "55vh" }}>
          <div className="split-pad" style={{ background: "#8B1A1A", padding: "56px 48px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "2.2rem", fontWeight: 500, color: "#fff", lineHeight: 1.1, marginBottom: 14 }}>ابدأ رحلتك<br /><span style={{ fontStyle: "italic", opacity: .3 }}>في رأس الحكمة</span></h2>
            ...
            <a href={`tel:${PHONE}`} dir="ltr" style={{ fontFamily: "'Playfair Display',serif", fontSize: "2rem", fontWeight: 600, color: "#fff", textDecoration: "none", marginBottom: 20 }}>0100 900 5579</a>
            <div style={{ display: "flex", gap: 10 }}>
              <a href={`${WA}?text=${encodeURIComponent("مرحباً، أنا مهتم بمشروع Palm Hills رأس الحكمة 1400 فدان")}`} target="_blank" rel="noopener noreferrer"
              ...
              <a href={`tel:${PHONE}`} style={{ padding: "12px 24px", border: "1px solid rgba(255,255,255,.25)", color: "#fff", fontWeight: 700, fontSize: ".78rem", textDecoration: "none", borderRadius: 8 }}>📞 اتصل الآن</a>
            </div>
          </div>
      ...
      <div className="float-desktop" style={{ position: "fixed", bottom: 76, left: 20, zIndex: 50, display: "flex", flexDirection: "column", gap: 8 }}>
        <a href={`tel:${PHONE}`} style={{ width: 48, height: 48, borderRadius: 12, background: "#8B1A1A", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 16px rgba(139,26,26,.3)", textDecoration: "none" }}>
